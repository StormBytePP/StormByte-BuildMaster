...
| `buildmaster_group_add(group member…)` | Membership (group / component / meta). Allowed before `buildmaster_group` |
...
`buildmaster_group_add` may run before `buildmaster_group`.
