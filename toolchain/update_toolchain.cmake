_bm_tc_export(BUILDMASTER_TOOLCHAIN_SRCDIR "${BUILDMASTER_TOOLCHAIN_SRCDIR}")
_bm_tc_export(BUILDMASTER_TOOLCHAIN_PROFILES_DIR "${BUILDMASTER_TOOLCHAIN_PROFILES_DIR}")
...
_bm_tc_export(BUILDMASTER_KNOWN_TOOLCHAINS "${_bm_known_export}")

# Native files are exported from _bm_tc_write_meson_native_file when
# generated (after this file runs on first include). Re-include is not required:
# each write calls _bm_tc_export for its variable.
