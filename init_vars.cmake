...
if(NOT BUILDMASTER_CONFIGURED)
	if(DEFINED BUILDMASTER_ROOT AND NOT "${BUILDMASTER_ROOT}" STREQUAL "")
		set(BUILDMASTER_SRCDIR "${BUILDMASTER_ROOT}")
	else()
	...
	# BUILDMASTER_LOG_NOCOLOR — default OFF (ANSI on). ENV or -D.
	if(DEFINED ENV{BUILDMASTER_LOG_NOCOLOR})
		string(TOUPPER "$ENV{BUILDMASTER_LOG_NOCOLOR}" _BM_NC)
		if(_BM_NC STREQUAL "1"
				OR _BM_NC STREQUAL "ON"
				OR _BM_NC STREQUAL "TRUE"
				OR _BM_NC STREQUAL "YES")
			set(BUILDMASTER_LOG_NOCOLOR ON)
		else()
			set(BUILDMASTER_LOG_NOCOLOR OFF)
		endif()
		unset(_BM_NC)
	elseif(BUILDMASTER_LOG_NOCOLOR)
		set(BUILDMASTER_LOG_NOCOLOR ON)
	else()
		set(BUILDMASTER_LOG_NOCOLOR OFF)
	endif()
